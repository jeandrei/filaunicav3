    ...
    class Admins extends Controller{
        ...
        public function index(){  
          ...
          $options = array(
            ...
            'named_params' => array(
                                    ':protocolo' => ($_GET['protocolo']) ? $_GET['protocolo'] : 'null',
                                    ':situacao_id' => ($_GET['situacao_id']) ? $_GET['situacao_id'] : 'null',
                                    ':etapa_id' => ($_GET['etapa_id']) ? $_GET['etapa_id'] : 'null',
                                    ':escola_id' => ($_GET['escola_id']) ? $_GET['escola_id'] : 'null',
                ...
                foreach($pagresults as $row){
                  $results[] = [
                    ...
                    'opcao2_id' => ($row['opcao2_id']) 
                              ...
                              : 'null',
                    'vagas_op2' => $this->escolaVagasModel->getEscolaVagasEtapa($row['opcao2_id'],$this->etapaModel->getEtapaId($row['nascimento'])),

<?php
	class Situacoes extends Controller{
		...
		//Lista as situações existentes
		public function index() {
			if($situacoes = $this->situacaoModel->getSituacoes()){
		...
		public function edit($id){
			...
			if($_SERVER['REQUEST_METHOD'] == 'POST'){  
				...
				$data = [
					'id' => $id,
					'descricao' => isset($situacao->descricao)
												? $situacao->descricao
												: '',
					'ativo' => isset($situacao->ativonafila)
												? $situacao->ativonafila
												: '',  
					'cor' => isset($situacao->cor)
												? $situacao->cor
												: '',                          
					'descricao_err' => '',
					'ativo_err' => '',

<?php
    class Admins extends Controller{
			...
			/*INDEX lista os registros da fila única*/
      ...
      //aqui é o método chamado pelo jquery lá no index, verifico se o id tem algum valor se sim eu chamo o método changeStatus no model ACHO QUE NÃO USA MAIS ESSA FUNÇÃO
      public function gravarApagar(){   				
				try{               
			...
			// Retorna o histórico de um registro a partir do id
      ...
      public function edit($id){ 
			...
			//Emite o relatório mensal com as matrículas realizadas no mês
		...
		//Emite o relatório de demanda, demanda de vagas por unidade
		...
		//Relatório de registros marcados como especial na fila
		...
		//Relatório de registros com siguação aguardando em ordem alfabética
		...
		//Relatório de quadro de vagas de unidades
		...
		//Grava a observação na tela admins em cada registro da fila
		...
		//Análize de registros duplicados. os registros duplicados são arquivados

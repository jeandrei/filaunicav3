	...
	class Filas extends Controller{
		...
		public function cad(){               
			...
			if($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				//valida a opção 01 tem que informar ao menos uma opção
				...
				if(     
					...
					$lastId = $this->filaModel->register($data);    
		...
		public function cadastrar(){ 
			/* se estiver configurado para não permitir duplicados 
			e a passoa tentar acessar pela url eu encerro aqui */
